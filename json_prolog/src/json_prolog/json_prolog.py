...
class PrologQuery(object):
    def __init__(self, query_str, simple_query_srv, next_solution_srv, finish_srv, iterative=True):
        """
        This class wraps around the different json_prolog services to provide a convenient python interface.
        :type query_str: str
        ...
        :param iterative: if False, all solutions will be calculated by json_prolog during the first service call
        :type iterative: bool
        """
...
class Prolog(object):
    def __init__(self, name_space='json_prolog', timeout=None):
        """
        :type name_space: str
        :param timeout: Amount of time in seconds spend waiting for json_prolog to become available.
        :type timeout: int
        """
    ...
    def query(self, query_str):
        """
        Returns an Object which asks json_prolog for one solution at a time.
        :type query_str: str
        :rtype: PrologQuery
        """
    ...
    def once(self, query_str):
        """
        Call json_prolog once and finished it.
        :type query_str: str
        :rtype: list
        """
        q = None
    ...
    def all_solutions(self, query_str):
        """
        Requests all solutions from json_prolog, this might take a long time!
        :type query_str: str
        :rtype: list
        """
