...
check_is_restriction_true(Entity, OWLRestriction, TestProperty, TestRange) :-
  ...
  assert_true(mongolog_call(triple(Entity,owl:'onProperty',TestProperty))),
  assert_true(mongolog_call(triple(Entity,OWLRestriction,TestRange))).

check_is_restriction_false(Entity, OWLRestriction, TestProperty, TestRange) :-
  assert_true(is_restriction(Entity)), 
  assert_true(mongolog_call(triple(Entity,owl:'onProperty',TestProperty))),
  assert_false(mongolog_call(triple(Entity,OWLRestriction,TestRange))).
...
% TODO
%tests('is_restriction(-,-)', throws(instantiation_error(_))) :-
...
test('is_union_of(+,-)') :-
  assert_true(mongolog_call((subclass_of(test:'EUnion',Union4),is_union_of(Union4,_)))),
  assert_true(
    mongolog_call(once((
...
test('disjoint_with_direct(+,+)::OWL1') :-
  assert_true(mongolog_owl:disjoint_with_direct(test:'DisjClsChain1',test:'DisjClsChain2')),
  assert_true(mongolog_owl:disjoint_with_direct(test:'DisjClsChain2',test:'DisjClsChain1')),
  assert_true(mongolog_owl:disjoint_with_direct(test:'DisjClsChain2',test:'DisjClsChain3')),
  %
  assert_false(mongolog_owl:disjoint_with_direct(test:'DisjClsChain1',test:'DisjClsChain3')),
  assert_false(mongolog_owl:disjoint_with_direct(test:'A',test:'B')).

test('disjoint_with_direct(+,-)::OWL1') :-
  findall(A, mongolog_owl:disjoint_with_direct(test:'DisjClsChain1',A), List),
  assert_equals(List, [test:'DisjClsChain2']).

test('disjoint_with_direct(-,+)::OWL1') :-
  findall(A, mongolog_owl:disjoint_with_direct(A,test:'DisjClsChain1'), List),
  assert_equals(List, [test:'DisjClsChain2']).
...
test('disjoint_with_indirect(+,+)::OWL1::indirect') :-
  assert_true(mongolog_owl:disjoint_with_indirect(
...
test('disjoint_with_direct(+,+)::OWL2') :-
  assert_true(mongolog_owl:disjoint_with_direct(test:'DisjCls1',test:'DisjCls2')),
  assert_true(mongolog_owl:disjoint_with_direct(test:'DisjCls3',test:'DisjCls2')),
  assert_true(mongolog_owl:disjoint_with_direct(test:'DisjCls1',test:'DisjCls3')).

test('disjoint_with_direct(-,+)::OWL2', fail) :-
  mongolog_owl:disjoint_with_direct(_,test:'DisjCls2').

test('disjoint_with_direct(+,-)::OWL2') :-
  findall(A, mongolog_owl:disjoint_with_direct(test:'DisjCls2',A), List),
...
:- end_mongolog_tests(mongolog_owl).
