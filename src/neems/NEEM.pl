...
%tests(mem_predicate_add_role) :-
  %test_action(TskNode,_,_),
  %mem_event_add_role(TskNode, knowrob:'Reasoner'),
  %mem_event_add_classification(TskNode,
      %tests:'predicate1', knowrob:'Reasoner').

%tests(mem_predicate_assignment) :-
  %test_action(TskNode,_,_),
  %mem_event_add_assignment(TskNode,
      %tests:'predicate1_Argument1',tests:'Bowl_0'),
  %mem_event_add_assignment(TskNode,
      %tests:'predicate1_Argument2',tests:'Artifact_0'),
  %%%
