...
%
% Start a new change stream operation on given collection and
% filter documents with given aggregation pipeline.
% Callback is the name of a 2-ary predicate that is called for each
...
% @param Callback name of the callback predicate
