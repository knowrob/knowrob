...
:- begin_tests('knowrob/reasoning/action_effects').
...
:- owl_parse('package://knowrob_common/owl/blocksworld.owl').
:- owl_parse('package://knowrob_common/owl/pancake.owl').
...
:- end_tests('knowrob/reasoning/action_effects').
