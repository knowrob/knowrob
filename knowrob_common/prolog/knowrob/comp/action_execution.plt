...
:- begin_tests('knowrob/comp/action_execution').
...
:- use_module(library('knowrob/model/Reification'), [ kb_reification/2 ]).
...
:- owl_parse('package://knowrob_common/owl/execution-test.owl').
...
test(rdf_has_execution_goal) :-
  'knowrob/comp/action_execution':plan_execution_goal_(
...
test('add_two_ints(CREATE)') :-
  ...
  'knowrob/comp/action_execution':plan_execution_create_(
      Action,
...
test('add_two_ints(ENCODE)') :-
  ...
  'knowrob/comp/action_execution':action_bindings_(acext:'add_two_ints_Execution',ActionDict),
  %%%%
...
test('sum_array(ENCODE)') :-
  ...
  'knowrob/comp/action_execution':action_bindings_(acext:'sum_array_Execution',ActionDict),
  %%%%
...
test('pose_test(ENCODE)') :-
  once(kb_triple(Action, dul:executesTask, acext:'pose_test_Task')),
  pose_test_input(InputDict),
  'knowrob/comp/action_execution':action_bindings_(acext:'pose_test_Execution',ActionDict),
  %%%%
...
:- end_tests('knowrob/comp/action_execution').
