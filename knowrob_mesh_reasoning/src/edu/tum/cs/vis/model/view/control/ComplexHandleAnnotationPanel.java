 ...
 * 
 */
public class ComplexHandleAnnotationPanel extends AnnotationPanel<ComplexHandleAnnotation> {
	 ...
	 *            main mesh cas
	 */
	public ComplexHandleAnnotationPanel(MeshCas cas) {
		super(ComplexHandleAnnotation.class, cas);
		...
		c.gridy = 0;
		c.weightx = 0.3;
		pnlInfo.add(new JLabel("Area Cone", SwingConstants.CENTER), c);
		c.gridx = 1;
		c.gridy = 0;
		c.weightx = 1.0;
	 ...
	 */
	@Override
	public void setSelected(ComplexHandleAnnotation annotation) {
		...
		if (annotation != null) {
			txtAreaTot.setText(String.valueOf(annotation.getAreaUnscaled()));
