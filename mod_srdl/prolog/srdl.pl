...
%% Load owl file(s)
:- owl_parser:owl_parse('/work/ros/tumros-internal/stacks/knowrob/mod_srdl/owl/GetFromRefrigerator.owl', false, false, true).
% :- owl_parser:owl_parse('/work/ros/tumros-internal/stacks/knowrob/mod_srdl/owl/SRDL.owl', false, false, true).
% :- owl_parser:owl_parse('/work/ros/tumros-internal/stacks/knowrob/mod_srdl/owl/TUM_Rosie.owl', false, false, true).
% :- owl_parser:owl_parse('/work/ros/tumros-internal/stacks/knowrob/mod_srdl/owl/PR2.owl', false, false, true).
