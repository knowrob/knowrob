...
public class DrinkingGlass extends Item {
	...
	public void drawIt(Canvas c) {
		...
		(new Cylinder(new Vector3f(0f, 0f, 0f), new Vector3f(0f, 0f, 0.5f), 4f)).draw(c); // foot
		(new Cylinder(new Vector3f(0f, 0f, 0f), new Vector3f(0f, 0f, 5f), 0.5f)).draw(c);  // 
		(new Cylinder(new Vector3f(0f, 0f, 5f), new Vector3f(0f, 0f, 15f), 3f)).draw(c);  // glass
