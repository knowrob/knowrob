...
public class Pizza extends Item {
	...
	public Pizza(float m00, float m01, float m02, float m03, float m10,
	...
	public Pizza(Matrix4d pose, Vector3d dim){
		super(pose, dim);
	}
	...
	public void drawIt(Canvas c) {
		...
		(new Cylinder(new Vector3f(0f, 0f, 0f), new Vector3f(0f, 0f, 1.65f), 10f)).draw(c); // lower part
