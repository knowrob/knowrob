...
public class HingedJoint extends Item {
	

	public HingedJoint(float m00, float m01, float m02, float m03, float m10,
	...
	public HingedJoint(Matrix4d pose, Vector3d dim){
		super(pose, dim);
	}
	...
	public void drawIt(Canvas c) {
		...
		(new ConePrimitive(new Vector3f(0f, 0f, -0.1f), new Vector3f(0f, 0f, 0.2f), 0.03f)).draw(c);
		
		c.translate(0.0f, 0.0f, 0.2f);
		c.box(0.06f, 0.06f, 0.06f);
