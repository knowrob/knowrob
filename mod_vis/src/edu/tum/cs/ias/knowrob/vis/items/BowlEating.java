...
public class BowlEating extends Item {

	public BowlEating(float m00, float m01, float m02, float m03, float m10,
	...
	public BowlEating(Matrix4d pose, Vector3d dim){
		super(pose, dim);
	}
	...
	public void drawIt(Canvas c) {
		...
		(new ConePrimitive(new Vector3f(0f, 0f, 0f), new Vector3f(0f, 0f, 0.10f), 0.08f)).draw(c); // lower part
