...
public class WordNetRDF2 {
	...
	public static void initialize() {
		...
		try {
			...
			IRI documentIRI = IRI
					.create(new File("/work/ros/tumros-internal/stacks/knowrob/comp_ehow/etc/wordnet/wordnet-synset.rdf").toURI());
			...
			IRI glossaryIRI = IRI
					.create(new File("/work/ros/tumros-internal/stacks/knowrob/comp_ehow/etc/wordnet/wordnet-glossary.rdf").toURI());
...
//			System.out.println(stem);
	...
	private static void cacheIrregularVerbs() throws IOException,
		...
		File verb_exc = new File(
				absoluteFilePath("/work/ros/tumros-internal/stacks/knowrob/comp_ehow/etc/wordnet/verb.exc"));
		if (!verb_exc.exists())
	...
	private static void cacheIrregularNouns() throws IOException,
		...
		File noun_exc = new File(
				absoluteFilePath("/work/ros/tumros-internal/stacks/knowrob/comp_ehow/etc/wordnet/noun.exc"));
		if (!noun_exc.exists())
			throw new FileNotFoundException(
